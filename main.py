...
def selfbot_menu(bot):
    ...
    print(f"""\n{Fore.RESET}
          ...
          \n""".replace('█', f'{b}█{y}'))
    print(f"""{y}------------------------------------------------------------------------------------------------------------------------
{w}raadev {b}|{w} https://github.com/cu7n-fraud {b}|{w} https://github.com/cu7n-fraud {b}|{w} https://github.com/cu7n-fraud {b}|{w} https://github.com
{y}------------------------------------------------------------------------------------------------------------------------\n""")
...
async def on_ready():
    if platform.system() == "Windows":
        ctypes.windll.kernel32.SetConsoleTitleW(f"SelfBot v{__version__} - Made By ctvs")
        os.system('cls')
    else:
        os.system('clear')
    selfbot_menu(bot)
...
async def help(ctx):
    ...
    help_text = f"""
**ctvs SelfBot | Prefix: `{prefix}`**\n
**Commands:**\n
> :space_invader: `{prefix}ctvs` - Show my social networks.
...
async def astraa(ctx):
    ...
    > :computer: `GitHub Page`\n*https://github.com/cu7n-fraud*
    > :robot: `SelfBot Project`\n*https://github.com/cu7n-fraud/Discord-SelfBot*"""
...
async def qr(ctx, *, text: str="https://discord.gg/"):
    qr = qrcode.make(text)
...
@bot.command()
async def spam(ctx, amount: int=1, *, message_to_send: str="https://discord.gg/"):
    await ctx.message.delete()
...
@bot.command()
async def sendall(ctx, *, message="https://discord.gg/"):
    await ctx.message.delete()
...
@bot.command()
async def dmall(ctx, *, message: str="https://discord.gg/"):
    await ctx.message.delete()
